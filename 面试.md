...
4. 开一个线程池ConnectionPool，优点：复用，创建使用销毁，最常用。
...
![image-20200424151651327](/Users/hawkii/自学MD/面试img/image-20200424151651327.png)
...
```java
@MapperScan(basePackages = "com.hawkii.springbootbook")
```
...
mybatis:
    ...
    type-aliases-package: com.hawkii.springbootbook.entity
```
...
![img](/Users/hawkii/自学MD/面试img/2012072810301161.png)

URI 统一资源标识符
URL 统一资源定位符

![image-20200422114129197](/Users/hawkii/自学MD/面试img/image-20200422114129197.png)
...
@NotNull//表单Integer 不为空
@NotEmpty//表单String 不为空
...
![抽象工厂模式的 UML 图](/Users/hawkii/自学MD/面试img/abstractfactory_pattern_uml_diagram.jpg)
